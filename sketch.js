...
function setup() {
  ...
  box2 = new Box(883, 100, 70, 70);
  box3 = new Box(883, 100, 70, 70);
  box4 = new Box(883, 100, 70, 70);
  box5 = new Box(883, 100, 70, 70);
  box6 = new Box(883, 100, 70, 70);
  box27= new Box(883,100,70,70);
...
box29= new Box(740,100,70,70)


box21= new Box(810,100,70,70)
